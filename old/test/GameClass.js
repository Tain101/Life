...
Game = function()//initilize variables in the constructor
{
	this.posX = 0;
	this.posY = 0;
	this.velX = 100;
...
Game.prototype.Tick = function(elapsed)//function declaration and implementaition.
{
	fps.update(elapsed);
	this.Logic(elapsed);
	this.Render(elapsed);
...
Game.prototype.Logic = function(elapsed)
{
	...
	InputManager.padUpdate(); //own class, imported in index.html
